...
const easy = [
  ...
  [48, ['52 ms', '82.11 %', '33.7 MB', '100 %']],

  // [344],
  [7, ['64 ms', '96.6 %', '35.5 MB', '92.71 %']],
  [387, ['60 ms', '99.68 %', '37.9 MB', '77.5 %']],
  [242, ['60 ms', '95.71 %', '35.8 MB', '93.88 %']],
  [125, ['60 ms', '96.8 %', '40.5 MB', '21.74 %']],
  [8, ['64 ms', '97.6 %', '37.2 MB', '14.29 %']],
  // [28],
  [38, ['52 ms', '89.99 %', '35.7 MB', '33.33 %']],
  // [14],

  [237, ['56 ms', '94.09 %', '35.6 MB', '58.33 %']],
  // [19],
  // [206],
  // [21],
  // [234],
  ...
  // [104],
  [98, ['56 ms', '96.7 %', '37.2 MB', '97.44 %']],
  [101, ['52 ms', '96.66 %', '35.8 MB', '30 %']],
  [102],
  [108],
